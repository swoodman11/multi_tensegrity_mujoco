...
from mujoco_physics_engine.tensegrity_mjc_simulation_config_3 import TensegrityMuJoCoSimulator as Simulator # Adjust import if needed
...
class TensegrityEnv(gym.Env):
    def __init__(self, obs_dim=None, visualize=False, obs_mode: str = "tier2", debug_enabled=False):
        ...
        xml_path = Path("mujoco_physics_engine/xml_models/three_3bar_new_platform_config_1.xml")
        self.sim = Simulator(
            xml_path=xml_path,
            obs_dim=obs_dim,
            obs_mode=obs_mode,
        ...
        self.num_actuators = 18  # 12 actuated cables
